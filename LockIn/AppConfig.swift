...
enum AppConfig {
    ...
    enum DefaultsKey {
        ...
        /// WaiveOffManager's local state (remaining weekly waive-offs per
        /// goal, plus which goals were already waived today) — this is
        /// now the sole record of that state; nothing else backs it up.
